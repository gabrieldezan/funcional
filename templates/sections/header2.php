...
#header{background:<?php echo $row_cores['cor_1'] ?>; color: #fff; padding-bottom: 30px}
#header i{color: #00B33E; margin-right: 5px;}
...
#header li a:hover{color: <?php echo $row_cores['cor_2'] ?>}

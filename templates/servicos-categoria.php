	    	...
	    	<?php $cont=0; while ($row_registros = mysqli_fetch_assoc($registros)) { ?>
	    		<div class="col-sm-6">
	    			<div class="segura-registros text-center">
		    				<center>
		    					<?php if(!empty($row_registros['registros_imagem'])){ ?><img src="<?php echo $raiz ?>timthumb.php?src=<?php echo $raiz ?>wt_admin/uploads/<?php echo $row_registros['registros_imagem'] ?>&zc=2&h=150&w=120"><?php } ?>
		    				</center>
		    				<div class="clear20"></div>

...
<div class="row">
    <div class="col-lg-12">
        <form id="registros_editar" method="post" enctype="multipart/form-data" class="form">
            ...
            <div class="form-group">
                <label>Preço</label>
                <input name="registros_preco" class="form-control" type="text" value="<?php echo $row_registros['registros_preco'] ?>">
            </div>
            <div class="form-group">
                <label>Descrição</label>
                <input name="registros_descricao" class="form-control" type="text" value="<?php echo $row_registros['registros_descricao'] ?>">
            </div>
            <?php } ?>

      ...
      <h3>Home</h3>
        <div id="templatesHome" >
          <form method="post" enctype="multipart/form-data" id="templates_ordem_alterar">
            ...
            <div class="templatesOpcoes">
              <div style="margin-bottom:10px;" class="template-grid transition">
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <h4><?php echo $row_templates['templates_home_titulo'] ?></h4>
                    <h5 style="color:green"><?php echo $row_templates['templates_home_arquivo'] ?></h5>
                    <input type="hidden" name="<?php echo $row_templates['templates_home_id'] ?>" value="">
                  </div>
            ...
            <?php } ?> 
          <div class="clear20"></div>
          <button type="submit" class="btn btn-primary botao-salvar-home"><i class="fa fa-floppy-o" aria-hidden="true"></i> Salvar</button>
        </form>
      </div>
    </div>
  </div>
...
$(document).ready(function(){
  ...
  $('#templates_ordem_alterar').submit(function(e){
        $('.load').show();
        e.preventDefault();

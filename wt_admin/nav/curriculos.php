	  ...
	  <div class="panel panel-default">
	    ...
	    <div id="collapse<?php echo $row_contato['Id']; ?>" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading<?php echo $row_contato['Id']; ?>">
	      <div class="panel-body">
	        ...
	        <strong>Área desejada:</strong> <?php echo $row_contato['area'] ?><br>
	        <strong>Anexo:</strong> <a href="<?php echo $raiz ?>uploads/curriculos/<?php echo $row_contato['file_curriculo'] ?>" target="_blank"><?php echo $row_contato['file_curriculo'] ?></a><br>
	        <br>
